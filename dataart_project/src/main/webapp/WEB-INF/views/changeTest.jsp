							...
							<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
								...
								<label><span>Start date:</span>
									<form:input id="dateStart" path="date_start" type="text"
									 cssClass="form-control" value="${dateStartFormatted}" required="true"/>
								</label>	
							</div>
							<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
								...
								<label><span>End date:</span>
									<form:input id="dateEnd" path="date_end" type="text"
									 cssClass="u-full-width form-control" value="${dateEndFormatted}" required="true"/>
								 </label>
							</div>
						</div>
					</div>
			...
			<input class="question-number" type="hidden" value="${i.index}">
				<div class="row">
					<div class="question col-xs-12 col-sm-12 col-md-7 col-lg-7">
						...
						<form:textarea path="questions[${i.index}].text" rows="7" class="form-control" placeholder="Question text" required="true"/>
					</div>	
